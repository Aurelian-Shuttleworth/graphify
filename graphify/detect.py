...
_SKIP_DIRS = {
    ...
    ".claude",  # agent scratch/worktree data — never architecturally meaningful
}
...
_SKIP_FILES = {
    ...
    # Nix lockfiles — autogenerated with hundreds of fetchurl bindings
    "bun.nix",
}
